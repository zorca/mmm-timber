...
function mmmtimber_get_context() {
    $cache = wp_cache_get('context', 'mmmtimber');
    ...
    wp_cache_set('context', $context, 'mmmtimber');
    return $context;
}

function mmmtimber_render_page($view, $context = array()) {
    get_header();
